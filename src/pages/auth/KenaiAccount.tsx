        ...
        <div className="space-y-6">
          ...
          <section className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-xl dark:border-white/10 dark:bg-slate-950/85 dark:text-white">
            <form className="space-y-4" onSubmit={handlePassword}>
              ...
              <input type="password" value={password} onChange={function (event) { setPassword(event.target.value) }} minLength={6} placeholder="New password" aria-label="New password" className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 dark:border-white/10 dark:bg-slate-900" />
