    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-slate-300">
        <section id="purpose">
          ...
          <p className="mt-3">This Acceptable Use Policy ("AUP") governs your conduct on Kenai Listings (kenailistings.com). It supplements our <Link to="/terms" className="text-sky-400 hover:underline">Terms of Service</Link> and is designed to ensure a safe, honest, and respectful marketplace for all users of the Kenai Peninsula community.</p>
        </section>
        ...
        <section id="discrimination">
          <h2 className="text-2xl font-semibold text-white">5. Anti-Discrimination</h2>
          <p className="mt-3">Users may not discriminate in any listing, communication, or transaction based on race, color, religion, sex, national origin, familial status, disability, age, sexual orientation, gender identity, or any other protected class under federal, state, or local law, including the Alaska Human Rights Law (AS 18.80).</p>
        </section>
