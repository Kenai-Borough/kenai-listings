    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-slate-300">
        ...
        <section id="contact">
          ...
          <p className="mt-3">Questions about our use of cookies? Contact us at <a href="mailto:privacy@kenailistings.com" className="text-sky-400 hover:underline">privacy@kenailistings.com</a> or <a href="mailto:legal@kenaiborough.com" className="text-sky-400 hover:underline">legal@kenaiborough.com</a>.</p>
        </section>
      </div>
    </div>
  );
