    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-slate-300">
        <section id="overview">
          ...
          <p className="mt-3">Kenai Listings (kenailistings.com) respects the intellectual property rights of others and complies with the Digital Millennium Copyright Act (DMCA), 17 U.S.C. § 512. We respond promptly to notices of alleged copyright infringement that comply with the DMCA and other applicable intellectual property laws.</p>
        ...
        <section id="agent">
          ...
          <div className="mt-3 rounded-2xl border border-white/10 bg-white/5 p-4">
            ...
            <p>Subject line: DMCA Notice — kenailistings.com</p>
