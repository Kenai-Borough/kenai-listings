    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <nav className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <ol className="mt-3 list-decimal list-inside space-y-1 text-sm text-sky-400">
            ...
            <li><a href="#classifieds-disclaimers" className="hover:text-sky-300 hover:underline">Classifieds Disclaimers</a></li>
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-slate-300">
        <section id="acceptance">
          ...
          <p className="mt-3">By accessing or using Kenai Listings ("kenailistings.com"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the platform. These Terms constitute a legally binding agreement between you and Kenai Peninsula Network / Kenai Borough LLC ("we," "us," or "our").</p>
        ...
        <section id="description">
          ...
          <p className="mt-3">Kenai Listings (kenailistings.com) is a local classifieds and general listings marketplace for the Kenai Peninsula, Alaska. The platform provides tools for posting and browsing listings for goods, services, housing, vehicles, jobs, and community items.</p>
        </section>
        ...
        <section id="third-party">
          ...
          <h2 className="text-2xl font-semibold text-white" id="classifieds-disclaimers">8. Classifieds Disclaimers</h2>
          <p className="mt-3">Users are solely responsible for the accuracy of their listings. Kenai Listings does not verify items, services, conditions, or the identity of sellers. Buyers and sellers interact at their own risk.</p>
          <p className="mt-3">For in-person exchanges, always meet in well-lit public places, bring a companion when possible, and never share personal financial information. The platform is not a party to any transaction and bears no responsibility for the quality, safety, legality, or delivery of listed items or services.</p>
        ...
        <section id="intermediary">
          ...
          <p className="mt-3">Kenai Listings operates as a technology platform that facilitates connections between users. We are not a party to any transaction between users. We do not guarantee the accuracy of listings, the quality of goods or services, the identity or qualifications of users, or the completion of any transaction. All dealings between users are solely between those parties.</p>
        </section>
        ...
        <section id="contact">
          ...
          <ul className="mt-2 space-y-1">
            ...
            <li>Website: <a href="https://kenailistings.com" className="text-sky-400 hover:underline">kenailistings.com</a></li>
