    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-slate-300">
        ...
        <section id="rights">
          ...
          <p className="mt-3">To exercise these rights, please contact us at <a href="mailto:privacy@kenailistings.com" className="text-sky-400 hover:underline">privacy@kenailistings.com</a>.</p>
        </section>

        <section id="ccpa">
          <h2 className="text-2xl font-semibold text-white">8. California Privacy Rights (CCPA)</h2>
          <p className="mt-3">If you are a California resident, you have additional rights under the California Consumer Privacy Act (CCPA), including the right to know what personal information is collected, the right to request deletion, and the right to opt out of the sale of personal information. We do not sell personal information. To submit a CCPA request, email <a href="mailto:privacy@kenailistings.com" className="text-sky-400 hover:underline">privacy@kenailistings.com</a>.</p>
        </section>

        <section id="gdpr">
          <h2 className="text-2xl font-semibold text-white">9. European Privacy Rights (GDPR)</h2>
          <p className="mt-3">If you are located in the European Economic Area (EEA) or the United Kingdom, you have rights under the General Data Protection Regulation (GDPR), including rights of access, rectification, erasure, restriction of processing, data portability, and the right to object. Our legal bases for processing include consent, contract performance, legitimate interests, and legal obligations. Contact <a href="mailto:privacy@kenailistings.com" className="text-sky-400 hover:underline">privacy@kenailistings.com</a> to exercise your rights.</p>
        </section>
        ...
        <section id="contact">
          ...
          <ul className="mt-2 space-y-1">
            <li>Privacy inquiries: <a href="mailto:privacy@kenailistings.com" className="text-sky-400 hover:underline">privacy@kenailistings.com</a></li>
