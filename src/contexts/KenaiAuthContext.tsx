  ...
  export const SITE_NAME = 'listings'
  export const SITE_LABEL = 'Kenai Listings'
  export const SITE_DOMAIN = 'https://kenailistings.com'
  ...
  export const SITE_ROLE_OPTIONS = [
    { value: 'buyer', label: 'Shop vehicles' },
{ value: 'seller', label: 'Sell vehicles' },
{ value: 'dealer', label: 'Manage dealer inventory' },
